  ...
  return (
    <Box sx={{ flexGrow: 1, bgcolor: secondaryColor, minHeight: '100vh', paddingBottom: 8 }}>
      ...
      >
        ...
        <BottomNavigationAction label={<Typography sx={{ fontSize: '0.7rem' }}>Post</Typography>} icon={<AddIcon sx={{ fontSize: '1.2rem', color: primaryColor }} />} /> {/* Assuming the middle icon is blue */}
